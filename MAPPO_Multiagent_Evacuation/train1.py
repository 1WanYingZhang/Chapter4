...
MAP_FILE = Path(__file__).resolve().parent / "map.txt"
...
def main() -> None:
    ...
    for update in range(1, num_updates + 1):
        ...
        buffer.compute_returns_and_advantages(next_value, last_done_tensor, cfg.gamma, cfg.gae_lambda)
