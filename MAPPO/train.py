...
def main() -> None:
    ...
    parser.add_argument("--local-view-radius", type=int, default=5)
    ...
    parser.add_argument("--num-envs", type=int, default=1, help="Number of synchronous vectorized environments.")
    ...
    vec_env = DummyVecEnv([lambda: build_env(args) for _ in range(args.num_envs)])
    env = vec_env.envs[0]
